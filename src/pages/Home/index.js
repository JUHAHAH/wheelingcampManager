...
const Info = () => {
  ...
  useEffect(() => {
    axios.get('https://wheelingcamp.store/manage/memberCount').then((data) => {
      const dateArr = [];
      const countArr = [];
    ...
    axios
      .get('https://wheelingcamp.store/manage/itemViewCount?categoryCode=1')
      .then((data) => {
        const carArr = [];
        const dateArr = [];
        for (const i in data.data) {
    ...
    axios
      .get('https://wheelingcamp.store/manage/itemViewCount?categoryCode=2')
      .then((data) => {
        const equipArr = [];
        for (const i in data.data) {
    ...
    axios
      .get('https://wheelingcamp.store/manage/itemViewCount?categoryCode=3')
      .then((data) => {
        const packageArr = [];
        for (const i in data.data) {
